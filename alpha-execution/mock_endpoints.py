"""
mock_endpoints.py — Alpha-Execution Mock Endpoints for Resilience Testing
...
logger = logging.getLogger("alpha_execution.mock_endpoints")
...
def exit_trade(request: ExitRequest) -> ExitResponse:
    ...
    try:
        ...
        # Calculate PnL (for call/put options: (exit - entry) * 100 * qty)
