...
if _current_dir not in _sys_early.path:
    _sys_early.path.insert(0, _current_dir)
...
try:
    ...
    ClearPendingRequest = mock_endpoints.ClearPendingRequest
    ClearPendingResponse = mock_endpoints.ClearPendingResponse
    clear_pending_picks = mock_endpoints.clear_pending_picks
